...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Carousel', path: '/carousels', entity: 'carousel', service: AccessServiceEnum.PROJECT, icon: FiSliders },
    {
      name: 'Contact Form',
      path: '/contact-forms',
      entity: 'contact_form',
    ...
    { name: 'Page', path: '/pages', entity: 'page', service: AccessServiceEnum.PROJECT, icon: FiFileText },
